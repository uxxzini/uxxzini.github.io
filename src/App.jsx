      ...
      <div className="max-w-[1200px] mx-auto px-8 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 border-t border-gray-100 py-12">
          ...
          <div className="lg:col-span-8 flex flex-wrap gap-3">
            ...
            "EDA", "Database Management", "Self-Motivated", "GIS",
  ...
  const timelineData = [
    {
      year: "2026",
      events: [
        { date: "02 - 05", title: "Reow", category: "experience" },
        { date: "01 - 04", title: "Pre", category: "education" },
        { date: "01 - 12", title: "Devel", category: "career" }
      ]
    },
    {
      year: "2025",
      events: [
        { date: "11 - 02", title: "Web", category: "career" },
        { date: "02 - 02", title: "Pre", category: "education" }
      ]
    },
    {
      year: "2024",
      events: [
        { date: "03 - 12", title: "On", category: "education" }
      ]
    },
    { year: "2023", events: [] },
    { year: "2022", events: [] },
    ...
    <div className="relative group flex items-center justify-center">
      <button
        ...
        className={`text-[20px] transition-all duration-300 ${
          activeFilter === id ? 'text-black scale-110' : 'text-gray-300 hover:text-gray-600'
        }`}
      >
        <Icon />
      </button>
      {/* 툴팁: 마우스 호버 시 상단에 나타남 */}
      <span className="absolute -top-10 left-1/2 -translate-x-1/2 px-2.5 py-1 bg-[#363636] text-white text-[11px] rounded opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap font-pretendard z-50">
        {label}
        {/* 화살표 꼬리 */}
        <span className="absolute top-full left-1/2 -translate-x-1/2 border-[5px] border-transparent border-t-[#363636]"></span>
      </span>
    </div>
  );
  ...
  return (
    <>
      ...
      >
        ...
        <div className="mt-8">
          <h2 className="font-display text-[28px] font-bold text-[#363636] mb-8">Bio</h2>

          {/* 탭 & 필터 영역 */}
          <div className="flex items-center justify-between border-b border-gray-100 pb-2 mb-10">
            <div className="flex space-x-6 font-pretendard text-[15px] font-medium text-black">
              <span className="border-b-2 border-black pb-2">Timeline</span>
            </div>
          ...
          <div className="relative">
            ...
            */}
            <div className="absolute left-[75px] top-2 bottom-0 w-[1px] bg-gray-100"></div>
            ...
            <div className="space-y-16">
              {filteredData.map((yearGroup, idx) => (
                <div key={idx} className="relative flex items-start">
                  ...
                  <div className="w-[65px] font-display text-[15px] font-bold text-gray-400 pt-0.5 text-left">
                    {yearGroup.year}
                  </div>
                    ...
                    {yearGroup.events.length > 0 ? (
                      yearGroup.events.map((event, eIdx) => (
                        <div key={eIdx} className="flex items-start font-pretendard">
                          <span className="w-16 flex-shrink-0 text-[13px] text-gray-300 font-medium pt-0.5">
                            {event.date}
                          </span>
                          <span className="text-[15px] text-[#555] leading-snug">
                            {event.title}
                          </span>
                        </div>
                      ))
